...
namespace LMSApp.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(LMSContext context, IAccountRepo accountRepo)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookTitle,NoOfCopies,AuthorId,PublisherId,Category,ImageUri,IssuesBooks,IsAvailable")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookTitle,NoOfCopies,AuthorId,PublisherId,Category,ImageUri,IssuesBooks,IsAvailable")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
